            ...
            {
                {
                    MyLanguagesEnum.English, new Dictionary<string, string>
                    {
                        ...
                        { "TerminalArmTitle", "Arm Warhead" },
                        { "ActionArmTitle", "Arm Warhead On/Off" },
                        ...
                        { "TerminalTargetClosestTitle", "Prioritize Closest" },
                        ...
                        { "TerminalMinLockTimeTooltip", "How many ticks minimum a weapon should spend locked on a projectile before the PD targeting computer can reassign it" },
                        { "ActionStateOn", "On" },
                        { "ActionStateOff", "Off" },
                        ...
                        { "ActionTargetLargeGrids", "Target Large Grids On/Off" },
                        { "ActionTargetSmallGrids", "Target Small Grids On/Off" },
                        ...
                        { "ActionWCTargetClosest", "Target Closest On/Off" },
                        { "ActionWCFireDistribution", "Enable PD Fire Distribution On/Off" },
                        { "ActionShootStatusStringInactive", "Inactive" },
                        { "ActionShootStatusStringShoot", "Once" },
                        { "ActionShootStatusStringToggleOn", "Toggle\n (C. On)" },
                        { "ActionShootStatusStringToggleOff", "Toggle\n(C. Off)" },
                        ...
                        { "WeaponInfoSystem", "Projectile Tag List Type:" },
                        { "WeaponInfoSystemBlacklistOr", "Blacklist, Or" },
                        { "WeaponInfoSystemBlacklistAnd", "Blacklist, And" },
                        { "WeaponInfoSystemWhitelistOr", "Whitelist, Or" },
                        ...
                        { $"TerminalPTagWhitelistToggleTooltip", "Determines whether the turret uses a whitelist or blacklist system to determine projectile targets,\n and then whether projectiles need all (And) or one (Or) tag for said whitelist/blacklist check." },
                        { $"TerminalPTagListTitle", "Projectile Tags:" },
                        { $"WeaponInfoAutoGenerated", "Weapon automatically converted to WC. Performance may differ from author intent." },
                        { $"WeaponAutoConvertDesc", "Weapon automatically converted to WC. Performance may differ from author intent.\n" },
                    }
                },
               {
                ...
                },
                {
                    MyLanguagesEnum.ChineseChina, new Dictionary<string, string>
                    {
                        ...
                        //{ "ReportTarget Toggle On/Off", "状态显示 开/关" },
                        //{ "ReportTarget On", "状态显示启用" },
                        //{ "ReportTarget Off", "状态显示关闭" },
                        ...
                        { "TerminalReportTargetTitle", "启用状态显示" },
                        { "TerminalReportTargetTooltip", "在右侧 HUD 上报告武器是否锁定目标，关闭则不显示“无目标”文字" },
                        { "TerminalWeaponROFTitle", "改变射速" },
                        { "TerminalWeaponROFTooltip", "改变射速" },
                        { "TerminalOverloadTitle", "超载伤害" },
                        { "TerminalOverloadTooltip", "能量武器特有的功能。造成双倍的伤害，但使用四倍的能量与产出四倍的热能，超载启用后，过热时会损伤武器" },
                        ...
                        { "TerminalArmTooltip", "弹头引信启用后可手动引爆，同时也会因撞击或不当操作而引爆" },
                        ...
                        { "TerminalNeutralsTooltip", "攻击中立状态的目标" },
                        { "TerminalUnownedTitle", "攻击无主目标" },
                        { "TerminalUnownedTooltip", "攻击无所有者的目标" },
                        { "TerminalFriendlyTitle", "攻击非威胁目标" },
                        { "TerminalFriendlyTooltip", "攻击没有威胁的目标" },
                        { "TerminalBiologicalsTitle", "攻击生物" },
                        { "TerminalBiologicalsTooltip", "攻击玩家与生物" },
                        { "TerminalProjectilesTitle", "拦截发射物" },
                        { "TerminalProjectilesTooltip", "攻击来袭的发射物" },
                        { "TerminalSupportingPDTitle", "辅助近迫防御" },
                        { "TerminalSupportingPDTooltip", "启用后会攻击所有进入射程内的敌方发射物，关闭后仅拦截瞄准自身网格的发射物" },
                        { "TerminalMeteorsTitle", "攻击流星" },
                        { "TerminalMeteorsTooltip", "拦截流星" },
                        { "TerminalGridsTitle", "攻击网格" },
                        { "TerminalGridsTooltip", "攻击指定尺寸的网格" },
                        { "TerminalFocusFireTitle", "集火" },
                        { "TerminalFocusFireTooltip", "向 HUD锁定 的目标发动集火; 警告:武器将不会自动接战其他目标" },
                        { "TerminalSubSystemsTitle", "子系统优先" },
                        { "TerminalSubSystemsTooltip", "向指定的子系统发动攻击" },
                        { "TerminalRepelTitle", "小型目标优先" },
                        { "TerminalRepelTooltip", "着重于小型威胁的拦截，注意：此功能并非拦截发射物，而是让武器优先攻击小型目标" },
                        ...
                        { "TerminalTrackingModeTitle", "目标类型" },
                        { "TerminalTrackingModeTooltip", "指定武器攻击哪种类型的目标（移动中的飞船，静止的飞船或空间站）" },
                        { "TerminalControlModesTitle", "控制模式" },
                        { "TerminalControlModesTooltip", "选择武器的瞄准控制模式" },
                        { "TerminalCameraChannelTitle", "武器摄像机频道" },
                        { "TerminalCameraChannelTooltip", "将此武器分配到一个摄像机频道" },
                        { "TerminalBurstShotsTitle", "点放射击次数" },
                        { "TerminalBurstShotsTooltip", "每次进行点放射击的次数" },
                        { "TerminalBurstDelayTitle", "射击间隔" },
                        { "TerminalBurstDelayTooltip", "武器的射击间隔(单位:帧,1/60秒)" },
                        ...
                        { "TerminalShootModeTitle", "射击模式" },
                        { "TerminalShootModeTooltip", "选择武器的开火方式" },
                        { "TerminalAiEnabledTitle", "启用AI" },
                        { "TerminalAiEnabledTooltip", "AI接管，自动进行瞄准与开火" },
                        { "TerminalShareFireControlTitle", "同步控制" },
                        { "TerminalShareFireControlTooltip", "其他武器若设定为手动/定点射击/鼠标控制模式，在使用控制模式后这些武器会同步射击" },
                        ...
                        { "TerminalCameraCameraChannelTitle", "摄像头频道" },
                        { "TerminalCameraCameraChannelTooltip", "将武器摄像头频道绑定到此摄像头" },
                        { "TerminalDebugTitle", "调试" },
                        { "TerminalDebugTooltip", "调试开/关" },
                        { "TerminalAdvancedTitle", "进阶功能" },
                        { "TerminalAdvancedTooltip", "启用高级 WeaponCore UI 功能与选项" },
                        { "TerminalShootTitle", "射击" },
                        { "TerminalShootTooltip", "射击开/关" },
                        { "TerminalTargetClosestTitle", "最近目标优先" },
                        { "TerminalTargetClosestTooltip", "优先攻击距离最近的网格或发射物" },
                        { "TerminalEnableFireDistributionTitle", "近防火力分配" },
                        { "TerminalEnableFireDistributionTooltip", "是否使近防武器将火力分配至多个目标" },
                        { "TerminalTurnCostTitle", "转向时间成本" },
                        { "TerminalTurnCostTooltip", "武器转向目标的时间成本乘数.与武器当前朝向角度偏差越大的目标,武器瞄准其的时间成本越高\n较小的值允许武器频繁大幅度转向以拦截各个方向的目标,较大的值则会使武器集中处理当前面向的目标" },
                        { "TerminalMinLockTimeTitle", "最小锁定时间" },
                        { "TerminalMinLockTimeTooltip", "近防武器保持目标锁定的最短时间(单位:帧,1/60秒),超过此时间后武器会重新分配目标" },
                        { "ActionStateOn", "开启" },
                        { "ActionStateOff", "关闭" },
                        { "ActionWCShootMode", "切换射击模式" },
                        { "ActionWCMouseToggle", "启用鼠标射击模式" },
                        { "ActionFire", "射击（触发模式：键盘发射）" },
                        { "ForceReload", "强制重新装填" },
                        { "TerminalForceReloadTooltip", "强制武器装填新选择的弹药种类，弹药将会退回库存（如果有空间）" },
                        { "ActionShoot", "射击开/关" },
                        { "ActionShoot_Off", "射击关闭" },
                        { "ActionShoot_On", "射击开启" },
                        { "ActionSubSystems", "循环切换锁定的子系统" },
                        { "ActionNextCameraChannel", "下一个频道" },
                        { "ActionPreviousCameraChannel", "上一个频道" },
                        { "ActionControlModes", "循环切换控制模式" },
                        { "ActionNeutrals", "攻击中立目标 开/关" },
                        { "ActionProjectiles", "拦截发射物 开/关" },
                        { "ActionSupportingPD", "辅助近迫防御 开/关" },
                        { "ActionBiologicals", "攻击生物 开/关" },
                        { "ActionMeteors", "攻击流星 开/关" },
                        { "ActionGrids", "攻击网格 开/关" },
                        { "ActionFriendly", "攻击友军目标 开/关" },
                        { "ActionUnowned", "攻击无主目标 开/关" },
                        { "ActionFocusTargets", "集火 开/关" },
                        { "ActionFocusSubSystem", "子系统优先 开/关" },
                        { "ActionMaxSizeIncrease", "增加最大目标尺寸" },
                        { "ActionMaxSizeDecrease", "减少最大目标尺寸" },
                        { "ActionMinSizeIncrease", "增加最小目标尺寸" },
                        { "ActionMinSizeDecrease", "减少最小目标尺寸" },
                        { "ActionTrackingMode", "切换追踪模式" },
                        { "ActionWC_CycleAmmo", "切换弹药" },
                        { "ActionWC_RepelMode", "拦截模式 开/关" },
                        { "ActionWC_Increase_CameraChannel", "下一个摄像机频道" },
                        { "ActionWC_Decrease_CameraChannel", "上一个摄像机频道" },
                        ...
                        { "WeaponInfoLoS", "视线" },
                        { "WeaponInfoShootingDisabled", "世界中禁止射击"},
                        //{ "WeaponTotalEffect", "伤害" },
                        //{ "WeaponTotalEffectAvgDps", "平均每秒伤害" },
                        { "TerminalOverrideTitle", "强制开火" },
                        { "TerminalOverrideTooltip", "当制导武器和炮塔处于此模式时，可以手动强制无目标射击" },
                        { "TerminalLGTitle", "大型网格" },
                        { "TerminalLGTooltip", "瞄准大型网格" },
                        { "TerminalSGTitle", "小型网格" },
                        { "TerminalSGTooltip", "瞄准小型网格" },
                        { "TerminalObjectiveTitle", "攻击模式" },
                        { "TerminalObjectiveTooltip", "选择武器攻击目标的方式\n失效：武器会攻击正在运行的方块，使其损坏\n摧毁：武器将持续攻击目标方块，直到其被摧毁" },
                        { "WeaponInfoHasTarget", "目标状态" },
                        { "WeaponInfoTargetState", "目标种类" },
                        { "WeaponInfoIdlePower", "待机功率" },
                        { "WeaponInfoMWLabel", "MW" },
                        { "WeaponInfoStatsHeader", "--- 状态 ---" },
                        { "WeaponInfoDPSLabel", "每秒伤害" },
                        { "WeaponInfoMinRange", "最小距离" },
                        { "WeaponInfoMaxRange", "最大距离" },
                        { "WeaponInfoROF", "最大射速" },
                        { "WeaponInfoEROF", "射速 (包含装填时间)" },
                        { "WeaponInfoMeter", "米" },
                        ...
                        { "WeaponInfoServerModdedLine2", "错误请向服务器管理员报告" },
                        { "WeaponInfoDrawOverMax", "耗能/最大功率 " },
                        { "WeaponInfoPowerCharged", "充能完成 " },
                        { "WeaponInfoPowerChargedIn", "充能时间: " },
                        { "WeaponInfoSeconds", "秒" },
                        { "WeaponInfoAmmoLabel", "弹药" },
                        { "WeaponInfoWaitingCharge", "等待充能" },
                        { "WeaponInfoLoadedIn", "预计装填时间: " },
                        { "WeaponInfoLoaded", "已装填" },
                        { "WeaponInfoNoammo", "没有可用弹药" },
                        { "WeaponInfoNoTarget", "没有目标" },
                        { "WeaponInfoHeatPerSecOverMax", "每秒产热/最大热量" },
                        { "SubtypeAny", "任何" },
                        { "SubtypeOffense", "武器系统" },
                        { "SubtypeUtility", "功能系统" },
                        { "SubtypePower", "电力系统" },
                        ...
                        { "ShootMouse", "鼠标控制（点击）" },
                        { "ShootKeyToggle", "按键触发（开/关）" },
                        { "ShootKey", "按键射击（单次射击）" },
                        { "ObjDefault", "默认" },
                        { "ObjDisabled", "失效" },
                        { "ObjDestroyed", "摧毁" },
                        { "ControlAuto", "自动（AI接管）" },
                        { "ControlManual", "手动控制（跟随屏幕准星指向）" },
                        { "ControlPainter", "定点射击（双击右键指定坐标）" },
                        { "MoveAny", "任意" },
                        { "MoveMoving", "移动中的飞船" },
                        { "MoveMoored", "空间站" },
                        { "WeaponInfoTrue", "启用" },
                        ...
                        { "WeaponTargTrue", "启用" },
                        { "WeaponTargFalse", "禁用" },
                        { "WeaponTargRange", "目标不在射程内" },
                        { "WeaponTargNeedSelection", "手动选择目标" },
                        { "WeaponTargTooClose", "目标距离过近" },
                        ...
                        { "WeaponInfoNoLarge", "无法瞄准大型网格！" },
                        { "WeaponInfoNoSmall", "无法瞄准小型网格！" },
                        { "WeaponInfoCenter", "武器瞄准网格中心位置" },
                        { "WeaponInfoTrackingAngle", "最大追踪角度" },
                        { "WeaponInfoNoSubsystem", "子系统选择不可用" },
                        { "WeaponInfoOutsideArc", "!! 目标未处于导引范围内 !! \n  !! 无法追踪目标 !!" },
                        { "WeaponInfoMaxReloadLabel", "剩余装填次数/总装填次数" },
                        { "WeaponInfoMaxReloadsHit", "剩余装填次数已耗尽\n  !! 武器无法工作 !!" },
                        { "WeaponInfoMaxReloadsDrone", "最大无人机部署数量" },
                        { "WeaponInfoMaxDroneLabel", "剩余无人机数量/无人机总数" },
                        { "WeaponInfoManualOnly", "!! 无法自动瞄准 !!\n!! 武器未具备此功能 !!" },
                        { "WeaponInfoEWARed", "!! 武器受到电磁干扰 !!"},
                        { "WeaponInfoBlockOff", "方块关闭"},
                        { "WeaponInfoBlockOffWarn", "!! 方块关闭 !!"},
                        { "WeaponInfoBlockFuncWarn", "!! 方块无法工作 !!"},
                    }
                }
            };
