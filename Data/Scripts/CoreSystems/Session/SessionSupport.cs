    ...
    public partial class Session
    {
                ...
                if (ControlRequest == ControlQuery.None)
                {
                    ...
                    if (tokenLength > 1)
                    {
                        switch (tokens[1])
                        {
                            ...
                            case "cs":
                                somethingUpdated = true;
                                ShowLocalNotify($"Shooting is {(Settings.Enforcement.ProhibitShooting ? "Disabled" : "Enabled")}", 5000, "White");
                                break;
        ...
        private void ModChecker()
        {
            ...
            foreach (var mod in Session.Mods)
            {
                ...
                if (mod.PublishedFileId == 1365616918 || mod.PublishedFileId == 2372872458 || mod.PublishedFileId == 3154379105 || mod.PublishedFileId == 3587786590)
                    ShieldMod = true;
