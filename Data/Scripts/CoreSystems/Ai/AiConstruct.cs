        ...
        public class Constructs
        {
            ...
            internal void Clean()
            {
                if (TotalEffect > 0)
                {
                    ...
                    Log.Stats($"{Ai.TopEntity?.DisplayName}\t{playerName}\t{(long)TotalEffect}\t{TotalPrimaryEffect}\t{TotalAoeEffect}\t{TotalShieldEffect}\t{TotalProjectileEffect}\t", Log.GridDmgStatsLog);
                }
